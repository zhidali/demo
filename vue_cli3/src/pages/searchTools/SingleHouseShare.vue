                    ...
                    <div class="step-user-require step-box-wrapper" v-show="currentIndex === 0">
                        <div class="center-header">
                            ...
                            <div class="header-step-status">
                                ...
                                />
                                <img
                                    src="../../../static/images/sreachTool/step_success.png"
                                    alt="成功标识"
                                    v-else
                                />
                            </div>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div class="dele-pic-wrapper">
                                                        ...
                                                        <img
                                                            src="../../../static/images/sreachTool/del_cell_hx.png"
                                                            alt="删除户型"
                ...
                <div class="right-header">
                    ...
                    <div class="user-info-box">
                        <div class="user-info-pic">
                            ...
                            <img
                                class="pic-icon"
                                src="../../../static/images/sreachTool/pic_v.png"
                                alt="头像大V"/>
                        </div>
                        ...
                        >
                            ...
                            >
                                <div class="bd-cont">
                                    ...
                                    <div class="cont-con">
                                        <img
                                            src="../../../static/images/sreachTool/audio_pic.png"
                                            alt="播放器图片"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="bd">
                                    <ul class="bd-info s-query">
                                        ...
                                        <li class="auto">
                                            ...
                                            <div class="th-link">
                                                <img
                                                    src="../../../static/images/sreachTool/turn_to.png"
                                                    alt="跳转到地图"
                                                />
                                            </div>
...
import start from '../../../static/images/sreachTool/start-one.png'
...
export default {
    ...
    created () {
        ...
        // oss直传
        this.getSign()
        this.qaCodeDefault = require('../../../static/images/sreachTool/qa_code_default.png')
    },
    mounted () {
        this.$nextTick(() => {
            // 获取通用下拉
    ...
    methods: {
        ...
        addCusHouse () {
            ...
            // 埋点
            CommonMethods.setTrack('4164', this.trackMessages, {}, this.backendApi)
        },
        // 户型图展示
        showImg (para) {
            let imgUrl
        ...
        chooseHx (para) {
            if (para.is_select + '' === '0') {
                ...
                // 埋点
                CommonMethods.setTrack('4166', this.trackMessages, {}, this.backendApi)
            }
            // 重新计算右侧各个模块高度，有图片需要延迟一会儿
            setTimeout(() => {
                this._calculateHeight()
        ...
        addLabel () {
            ...
            if (cusStr.trim()) {
                ...
                // 埋点
                CommonMethods.setTrack('4162', this.trackMessages, {}, this.backendApi)
            }
        },
        // 选中系统标签切换
        changeChosen (para) {
            if (para.is_select.toString() === '0') {
                ...
                CommonMethods.setTrack('4161', this.trackMessages, trackObj, this.backendApi)
            } else {
                para.is_select = '0'
                // 增加右侧预览
