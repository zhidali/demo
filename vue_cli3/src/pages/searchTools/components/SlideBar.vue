                            ...
                            >
                                <div :class="{'items': !(currenChosen.subIndex === subIndex), 'items items-active': currenChosen.subIndex === subIndex}">
                                    <h3>
                                        ...
                                        >
                                            <img
                                                src="../../../../static/images/sreachTool/icon-new.png"
                                                alt="new文章图片"
                                            >
                                        </div>
                                    </h3>
                    ...
                    <div class="jl-artcel-details">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="../../../../static/images/sreachTool/icon-replay.png"
                                        alt="重播"
                                    >
                    ...
                    <div class="top-con">
                        <div class="add-house">
                            ...
                            <div class="opt search-house">
                                <img
                                    src="../../../../static/images/sreachTool/search.png"
                                    alt="搜索楼盘"
                                />
                                <el-autocomplete
...
import shareApi from '@/api/searchToolsApi/searchToolShare';
...
export default {
    ...
    methods: {
        ...
        recommHouse(type) {
            // 确定
            if (type === 2) {
                this.projectInfos = commonFn.deepClone(this.projectInfosTwo);
            }
        ...
        async getArticleInit(id) {
            try {
                ...
                if (data.code === 0) {
                    ...
                    if (findInd < 0) {
                        this.projectInfos = data.data.project_info ? commonFn.deepClone(data.data.project_info) : [];
                        this.projectInfosTwo = data.data.project_info ? commonFn.deepClone(data.data.project_info) : [];
                    } else {
                        this.projectInfos = commonFn.deepClone(this.totalProInfo[findInd].project_info);
                        this.projectInfosTwo = commonFn.deepClone(this.totalProInfo[findInd].project_info);
                    }
                    // 如果有楼盘 就默认推荐 否则默认不推荐
        ...
        async bindWechat() {
            try {
                ...
                // 第三个参数为固定参数7
                const { data: { code, msg, data } } = await addWxContact(this.orderId, wechateAccount, '7');
                if (code === 0) {
                    this.$message(msg);
                } else {
                    this.$message(msg);
        ...
        async smsShareHandle() {
            try {
                if (this.smsVal && !commonFn.verifyTelNum(this.smsVal)) {
        ...
        createCityInfo() {
            ...
            const cityName = this.cityInfo.currentCity.split(',');
