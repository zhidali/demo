            ...
            <div class="his-bd">
              <ul class="his-list-box">
                <li v-for="(his, index) in hisLocal" :key="'hisLocal-' + index" @click="chooseHisLocal(index)">
                  <div class="item-pic"><img src="../../../../static/images/sreachTool/list-position.png"></div>
      ...
      <div class="sub-header">
        <div class="search-result-box">
          <div class="result-box-left" @click="turnSearch">
            <img src="../../../../static/images/sreachTool/icon_turn.png">
          </div>
            ...
            <li class="drive-box">
              <div class="result-box">
                <div class="list-result-hd">
                  <div class="result-hd-img"><img src="../../../../static/images/sreachTool/local_icon.png"></div>
                  ...
                  <div class="list-result-box">
                    ...
                    <div class="result-bd-box">
                      <div class="box-discrib">
                        ...
                        <div class="time-sub">
                          <div class="time-sub-icon"><img src="../../../../static/images/sreachTool/work_by_foot.png"></div>
                        ...
                        <div class="line-item" v-for="(line, index) in bus.busLine" :key="'line-' + index">
                          <div :class="{'item-info item-into-btn item-bus': line.type.toString() !== '1', 'item-info item-into-btn item-car': line.type.toString() === '1'}">
                            <div class="item-info-pic">
                              <img src="../../../../static/images/sreachTool/transit_icon.png" v-if="line.type.toString() === '1'">
                              <img src="../../../../static/images/sreachTool/metro_icon.png" v-else>
                            </div>
...
export default {
  ...
  methods: {
    ...
    chooseHisLocal (para) {
      ...
      // 添加到vuex中保存
      this.$store.dispatch('get_commu', this.checkAddress)
      this.searchFlag = false
      // 请求添加到历史记录
      let params = {
        order_id: this.$route.query.order_id,
    ...
    setPlace (para) {
      ...
      function myFun () {
        ...
        // 添加到vuex中保存
        _this.$store.dispatch('get_commu', _this.checkAddress)
        // 请求添加到历史记录
        let params = {
