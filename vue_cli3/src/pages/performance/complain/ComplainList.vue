...
<script>
    ...
    import { COMPLAIN_PROGRESS, COMPLAIN_CHANNELS_INCLUD_ONLINE } from './js/DataConfig';
    ...
    export default {
        ...
        methods: {
            ...
            async updateComplaint() {
                ...
                if (!CommonMethods.trim(this.complainResult) || CommonMethods.trim(this.complainResult) === '') {
                    this.dialogTips = '处理结果不能为空！';
                    return false;
                } else if (CommonMethods.trim(this.complainResult).length > 300) {
                    this.dialogTips = '处理结果最多输入300个字！';
                    return false;
                }
                let params = {
                    id: this.dialogData.id,
                    handle_result: CommonMethods.trim(this.complainResult)
                };
