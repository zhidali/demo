                ...
                <ul class="file-list-box">
                  <li class="item-box" v-for="(item,index) in answerInfo" :key="index">
                    ...
                    <div class="author-wrap">
                        ...
                        <div class="edit-con" v-if="item.is_edit"  @click="editIsShowState(item,index)"><img src="./images/edit-point.png"></div>
                        ...
                        <div class="give-wrap">
                            <span class="give-after" v-if="item.is_like" @click="likeHandler(item)">
                              <i class="img-warp"><img src="./images/give-liked.png"></i>
                              <span class="number">{{item.likes}}</span>
                            </span>
                            <span class="give-before" v-else  @click="likeHandler(item)">
                              <i class="img-warp"><img src="./images/give-like.png"></i>
                              <span class="number">{{item.likes}}</span>
                            </span>
                        </div>
                    </div>
